...
export interface FileValidationResult {                 // summary of validation results for the whole file
  validCount: number;
  invalidCount: number;
  tooManyInvalid: boolean;
}

export function validateFile(rows: TransactionDraft[]): FileValidationResult {    //returns a summary of validation results for the whole file
