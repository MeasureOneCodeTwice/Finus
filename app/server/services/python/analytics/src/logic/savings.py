...
def calculate_savings_over_time(
    ...
    if period in ['w', 'm']:
        ...
        for month in pd.date_range(start=start_date, end=end_date, freq='ME'):#change this for production - GitHub actions might fail if this is ME, and work with M instead
