...
import type { SavingAccountType } from "../src/types/SavingAccountType.ts";
    ...
    const mockRows = [
      {
        ...
        name: "Savings A",
        balance: 1000,
        subtype: "TFSA" as SavingAccountType,
      ...
      },
      {
        ...
        name: "Savings B",
        balance: 9000,
        subtype: "RRSP" as SavingAccountType,
    ...
    const mockRows = [
      {
        ...
        balance: 500,
        type: "Savings" as FinancialAccountType,
        subtype: "RESP" as SavingAccountType,
        last_updated: null,
      },
    ];
...
describe("addSavingAccount", () => {
  ...
  it("should insert saving account and link profiles", async () => {
    (mockConnection.execute as unknown as ReturnType<typeof vi.fn>)
    ...
    (
      mockConnection.query as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValueOnce([]);

    const result = await addSavingAccount(mockDb as Pool, newSavings, userId);
